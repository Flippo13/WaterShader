...
void LitMaterial::render(World* pWorld, Mesh* pMesh, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix, glm::vec4& pClipPlanePosition)
{
	_shader->use();
	...
	glUniform3fv(_shader->getUniformLocation("light.lightPosition"), 1, glm::value_ptr(currentLight->getWorldPosition())); //might need to be changed to world pos
